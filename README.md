...
```javascript
gsortins = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsortins@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-gsortins/tags). For example,

```javascript
gsortins = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsortins@v0.3.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var gsortins = require( 'path/to/vendor/umd/blas-ext-base-gsortins/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsortins@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-ext-base-gsortins.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-ext-base-gsortins

[test-image]: https://github.com/stdlib-js/blas-ext-base-gsortins/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-gsortins/actions/workflows/test.yml?query=branch:v0.3.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-ext-base-gsortins/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-ext-base-gsortins?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-gsortins.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-gsortins/main
...
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-gsortins/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-gsortins/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-gsortins/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-gsortins/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-gsortins/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-gsortins/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-ext-base-gsortins/main/LICENSE
